...
vec3 getHolographicMaterial(vec3 normal, vec3 viewDir, float time) {
  float f = pow(1.0 - max(dot(normal, viewDir), 0.0), 2.0);
...
export const Scene: FC = () => {
  ...
  return (
    <div className="h-full w-full bg-gradient-to-b from-black via-neutral-950 to-emerald-900">
      <Canvas
        camera={cameraConfig}
        dpr={1}
        frameloop="always"
