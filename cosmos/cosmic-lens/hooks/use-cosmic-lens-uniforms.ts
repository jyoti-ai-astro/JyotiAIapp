...
import { CosmicLensMotionState } from './use-cosmic-lens-motion';

export interface CosmicLensUniforms {
  uTime: { value: number };
...
export function useCosmicLensUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CosmicLensMotionState,
  breathPhase: number,
