...
export interface CosmicLensMotionState {
  time: number;
...
export function useCosmicLensMotion(): CosmicLensMotionState {
  const stateRef = useRef<CosmicLensMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
