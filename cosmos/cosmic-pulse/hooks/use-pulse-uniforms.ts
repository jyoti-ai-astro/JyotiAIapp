 ...
 * 
 * Manages time, scroll, audio, and mouse uniforms for pulse field shader
 */
...
export interface UsePulseUniformsProps {
  /** Mouse position */
  ...
  /** Layer type (0: Radial Pulse, 1: Center Core, 2: Shockwave) */
  layerType?: number;
...
export function usePulseUniforms(
  material: THREE.ShaderMaterial | null,
  props: UsePulseUniformsProps
) {
  useFrame((state) => {
