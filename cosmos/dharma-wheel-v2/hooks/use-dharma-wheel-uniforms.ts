...
import { DharmaWheelMotionState } from './use-dharma-wheel-motion';

export interface DharmaWheelUniforms {
  uTime: { value: number };
...
export function useDharmaWheelUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: DharmaWheelMotionState,
  breathPhase: number,
