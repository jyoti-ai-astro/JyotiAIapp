...
import { StarFallMotionState } from './use-starfall-motion';

export interface StarFallUniforms {
  uTime: { value: number };
...
export function useStarFallUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: StarFallMotionState,
  breathPhase: number,
