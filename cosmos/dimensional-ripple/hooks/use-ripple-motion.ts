/**
 * Dimensional Ripple Motion Hook
 * 
...
export interface DimensionalRippleMotionState {
  time: number;
...
export function useDimensionalRippleMotion(): DimensionalRippleMotionState {
  const stateRef = useRef<DimensionalRippleMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
