...
export interface AuroraVeilMotionState {
  time: number;
...
export function useAuroraVeilMotion(): AuroraVeilMotionState {
  const stateRef = useRef<AuroraVeilMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
