...
import { AuroraVeilMotionState } from './use-aurora-motion';

export interface AuroraVeilUniforms {
  uTime: { value: number };
...
export function useAuroraVeilUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AuroraVeilMotionState,
  breathPhase: number,
