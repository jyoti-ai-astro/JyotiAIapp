...
export interface FateRippleMotionState {
  time: number;
...
export function useFateRippleMotion(): FateRippleMotionState {
  const stateRef = useRef<FateRippleMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
