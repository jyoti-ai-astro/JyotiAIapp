...
import { FateRippleMotionState } from './use-ripple-motion';

export interface FateRippleUniforms {
  uTime: { value: number };
...
export function useFateRippleUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: FateRippleMotionState,
  breathPhase: number,
