 ...
 * 
 * Maps bass/mid/high frequencies to chakra ring shader uniforms
 */

import { useMemo } from 'react';

export interface UseChakraAudioProps {
...
export interface ChakraAudioValues {
  bass: number;
  mid: number;
  high: number;
}

export function useChakraAudio(
  props: UseChakraAudioProps
): ChakraAudioValues {
  return useMemo(() => {
