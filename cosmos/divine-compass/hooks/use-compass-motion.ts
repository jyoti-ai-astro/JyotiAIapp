...
export interface CompassMotionState {
  time: number;
...
export function useCompassMotion(): CompassMotionState {
  const stateRef = useRef<CompassMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
