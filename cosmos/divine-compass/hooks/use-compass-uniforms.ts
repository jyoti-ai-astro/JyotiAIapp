...
import { CompassMotionState } from './use-compass-motion';

export interface CompassUniforms {
  uTime: { value: number };
...
export function useCompassUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CompassMotionState,
  breathPhase: number,
