...
import { SoulStarMotionState } from './use-star-motion';

export interface SoulStarUniforms {
  uTime: { value: number };
...
export function useSoulStarUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: SoulStarMotionState,
  breathPhase: number,
