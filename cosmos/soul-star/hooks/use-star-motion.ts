...
export interface SoulStarMotionState {
  time: number;
...
export function useSoulStarMotion(): SoulStarMotionState {
  const stateRef = useRef<SoulStarMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
