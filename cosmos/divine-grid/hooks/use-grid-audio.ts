 ...
 * 
 * Maps bass/mid/high frequencies to grid shader uniforms
 */

import { useMemo } from 'react';

export interface UseGridAudioProps {
...
export interface GridAudioValues {
  bass: number;
  mid: number;
  high: number;
}

export function useGridAudio(
  props: UseGridAudioProps
): GridAudioValues {
  return useMemo(() => {
