...
export interface SolarArcMotionState {
  time: number;
...
export function useSolarArcMotion(): SolarArcMotionState {
  const stateRef = useRef<SolarArcMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
