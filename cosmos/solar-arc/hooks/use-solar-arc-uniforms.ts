...
import { SolarArcMotionState } from './use-solar-arc-motion';

export interface SolarArcUniforms {
  uTime: { value: number };
...
export function useSolarArcUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: SolarArcMotionState,
  breathPhase: number,
