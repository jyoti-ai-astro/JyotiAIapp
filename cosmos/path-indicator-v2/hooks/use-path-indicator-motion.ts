...
export interface PathIndicatorMotionState {
  time: number;
...
export function usePathIndicatorMotion(): PathIndicatorMotionState {
  const stateRef = useRef<PathIndicatorMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
