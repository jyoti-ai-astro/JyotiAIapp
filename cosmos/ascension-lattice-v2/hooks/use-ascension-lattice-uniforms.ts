/**
 * Ascension Lattice v2 Uniforms Hook
 * 
...
import { AscensionLatticeMotionState } from './use-ascension-lattice-motion';

export interface AscensionLatticeUniforms {
  uTime: { value: number };
...
export function useAscensionLatticeUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AscensionLatticeMotionState,
  breathPhase: number,
