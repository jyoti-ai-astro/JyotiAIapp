/**
 * Ascension Lattice v2 Motion Hook
 * 
...
export interface AscensionLatticeMotionState {
  time: number;
...
export function useAscensionLatticeMotion(): AscensionLatticeMotionState {
  const stateRef = useRef<AscensionLatticeMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
