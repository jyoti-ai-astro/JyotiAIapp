...
import { SoulBridgeMotionState } from './use-soul-bridge-motion';

export interface SoulBridgeUniforms {
  uTime: { value: number };
...
export function useSoulBridgeUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: SoulBridgeMotionState,
  breathPhase: number,
