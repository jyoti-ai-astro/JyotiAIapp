...
export interface SoulBridgeMotionState {
  time: number;
...
export function useSoulBridgeMotion(): SoulBridgeMotionState {
  const stateRef = useRef<SoulBridgeMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
