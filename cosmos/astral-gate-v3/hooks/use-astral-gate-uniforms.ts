...
import { AstralGateMotionState } from './use-astral-gate-motion';

export interface AstralGateUniforms {
  uTime: { value: number };
...
export function useAstralGateUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AstralGateMotionState,
  breathPhase: number,
