/**
 * Celestial Crown v2 Uniforms Hook
 * 
...
import { CelestialCrownMotionState } from './use-celestial-crown-motion';

export interface CelestialCrownUniforms {
  uTime: { value: number };
...
export function useCelestialCrownUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CelestialCrownMotionState,
  breathPhase: number,
