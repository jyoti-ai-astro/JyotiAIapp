...
export interface CelestialRibbonMotionState {
  time: number;
...
export function useCelestialRibbonMotion(): CelestialRibbonMotionState {
  const stateRef = useRef<CelestialRibbonMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
