...
export interface AstralMandalaMotionState {
  time: number;
...
export function useAstralMandalaMotion(): AstralMandalaMotionState {
  const stateRef = useRef<AstralMandalaMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
