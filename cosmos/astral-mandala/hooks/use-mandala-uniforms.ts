...
import { AstralMandalaMotionState } from './use-mandala-motion';

export interface AstralMandalaUniforms {
  uTime: { value: number };
...
export function useAstralMandalaUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AstralMandalaMotionState,
  breathPhase: number,
