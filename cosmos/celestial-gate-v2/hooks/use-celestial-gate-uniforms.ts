/**
 * Celestial Gate v2 Uniforms Hook
 * 
...
import { CelestialGateMotionState } from './use-celestial-gate-motion';

export interface CelestialGateUniforms {
  uTime: { value: number };
...
export function useCelestialGateUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CelestialGateMotionState,
  breathPhase: number,
