...
export interface CelestialGateMotionState {
  time: number;
...
export function useCelestialGateMotion(): CelestialGateMotionState {
  const stateRef = useRef<CelestialGateMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
