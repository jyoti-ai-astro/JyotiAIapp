...
import { AstralTrailMotionState } from './use-trail-motion';

export interface AstralTrailUniforms {
  uTime: { value: number };
...
export function useAstralTrailUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AstralTrailMotionState,
  breathPhase: number,
