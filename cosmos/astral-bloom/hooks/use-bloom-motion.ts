...
export interface AstralBloomMotionState {
  time: number;
...
export function useAstralBloomMotion(): AstralBloomMotionState {
  const stateRef = useRef<AstralBloomMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
