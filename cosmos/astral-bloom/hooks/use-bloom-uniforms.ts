...
import { AstralBloomMotionState } from './use-bloom-motion';

export interface AstralBloomUniforms {
  uTime: { value: number };
...
export function useAstralBloomUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AstralBloomMotionState,
  breathPhase: number,
