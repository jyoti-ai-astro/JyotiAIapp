/**
 * Celestial Wave v2 Uniforms Hook
 * 
...
import { CelestialWaveMotionState } from './use-celestial-wave-motion';

export interface CelestialWaveUniforms {
  uTime: { value: number };
...
export function useCelestialWaveUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CelestialWaveMotionState,
  breathPhase: number,
