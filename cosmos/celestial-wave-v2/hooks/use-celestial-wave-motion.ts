...
export interface CelestialWaveMotionState {
  time: number;
...
export function useCelestialWaveMotion(): CelestialWaveMotionState {
  const stateRef = useRef<CelestialWaveMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
