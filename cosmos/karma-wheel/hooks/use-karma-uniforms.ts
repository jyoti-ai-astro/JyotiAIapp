...
import { KarmaWheelMotionState } from './use-karma-motion';

export interface KarmaWheelUniforms {
  uTime: { value: number };
...
export function useKarmaWheelUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: KarmaWheelMotionState,
  breathPhase: number,
