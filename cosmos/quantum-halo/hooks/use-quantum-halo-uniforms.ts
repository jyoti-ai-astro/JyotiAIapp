...
import { QuantumHaloMotionState } from './use-quantum-halo-motion';

export interface QuantumHaloUniforms {
  uTime: { value: number };
...
export function useQuantumHaloUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: QuantumHaloMotionState,
  breathPhase: number,
