/**
 * Cosmic Drift Field Uniforms Hook
 * 
...
import { CosmicDriftFieldMotionState } from './use-drift-field-motion';

export interface CosmicDriftFieldUniforms {
  uTime: { value: number };
...
export function useCosmicDriftFieldUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CosmicDriftFieldMotionState,
  breathPhase: number,
