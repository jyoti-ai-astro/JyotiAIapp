/**
 * Cosmic Drift Field Motion Hook
 * 
...
export interface CosmicDriftFieldMotionState {
  time: number;
...
export function useCosmicDriftFieldMotion(): CosmicDriftFieldMotionState {
  const stateRef = useRef<CosmicDriftFieldMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
