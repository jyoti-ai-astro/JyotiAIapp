...
import { AstralVeilMotionState } from './use-veil-motion';

export interface AstralVeilUniforms {
  uTime: { value: number };
...
export function useAstralVeilUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AstralVeilMotionState,
  breathPhase: number,
