...
export interface AstralVeilMotionState {
  time: number;
...
export function useAstralVeilMotion(): AstralVeilMotionState {
  const stateRef = useRef<AstralVeilMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
