...
import { KarmicThreadMotionState } from './use-karmic-thread-motion';

export interface KarmicThreadUniforms {
  uTime: { value: number };
...
export function useKarmicThreadUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: KarmicThreadMotionState,
  breathPhase: number,
