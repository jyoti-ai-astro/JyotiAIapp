...
export interface KarmicThreadMotionState {
  time: number;
...
export function useKarmicThreadMotion(): KarmicThreadMotionState {
  const stateRef = useRef<KarmicThreadMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
