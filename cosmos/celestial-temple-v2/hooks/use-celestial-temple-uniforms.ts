/**
 * Celestial Temple v2 Uniforms Hook
 * 
...
import { CelestialTempleMotionState } from './use-celestial-temple-motion';

export interface CelestialTempleUniforms {
  uTime: { value: number };
...
export function useCelestialTempleUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CelestialTempleMotionState,
  breathPhase: number,
