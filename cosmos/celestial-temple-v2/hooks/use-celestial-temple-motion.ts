/**
 * Celestial Temple v2 Motion Hook
 * 
...
export interface CelestialTempleMotionState {
  time: number;
...
export function useCelestialTempleMotion(): CelestialTempleMotionState {
  const stateRef = useRef<CelestialTempleMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
