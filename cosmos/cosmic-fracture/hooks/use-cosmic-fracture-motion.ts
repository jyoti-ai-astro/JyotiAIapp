...
export interface CosmicFractureMotionState {
  time: number;
...
export function useCosmicFractureMotion(): CosmicFractureMotionState {
  const stateRef = useRef<CosmicFractureMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
