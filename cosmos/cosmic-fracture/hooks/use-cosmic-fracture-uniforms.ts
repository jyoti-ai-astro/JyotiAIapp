...
import { CosmicFractureMotionState } from './use-cosmic-fracture-motion';

export interface CosmicFractureUniforms {
  uTime: { value: number };
...
export function useCosmicFractureUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CosmicFractureMotionState,
  breathPhase: number,
