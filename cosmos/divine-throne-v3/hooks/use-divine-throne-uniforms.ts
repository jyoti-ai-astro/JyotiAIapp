/**
 * Divine Throne v3 Uniforms Hook
 * 
...
import { DivineThroneMotionState } from './use-divine-throne-motion';

export interface DivineThroneUniforms {
  uTime: { value: number };
...
export function useDivineThroneUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: DivineThroneMotionState,
  breathPhase: number,
