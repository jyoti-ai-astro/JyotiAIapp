...
import { GatewayMotionState } from './use-gateway-motion';

export interface GatewayUniforms {
  uTime: { value: number };
...
export function useGatewayUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: GatewayMotionState,
  breathPhase: number,
