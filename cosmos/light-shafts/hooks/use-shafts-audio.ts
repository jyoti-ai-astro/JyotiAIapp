 ...
 * 
 * Maps bass/mid/high frequencies to light shafts shader uniforms
 */

import { useMemo } from 'react';

export interface UseShaftsAudioProps {
...
export interface ShaftsAudioValues {
  bass: number;
  mid: number;
  high: number;
}

export function useShaftsAudio(
  props: UseShaftsAudioProps
): ShaftsAudioValues {
  return useMemo(() => {
