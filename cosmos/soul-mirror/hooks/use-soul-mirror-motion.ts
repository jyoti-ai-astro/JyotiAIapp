...
export interface SoulMirrorMotionState {
  time: number;
...
export function useSoulMirrorMotion(): SoulMirrorMotionState {
  const stateRef = useRef<SoulMirrorMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
