...
import { SoulMirrorMotionState } from './use-soul-mirror-motion';

export interface SoulMirrorUniforms {
  uTime: { value: number };
...
export function useSoulMirrorUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: SoulMirrorMotionState,
  breathPhase: number,
