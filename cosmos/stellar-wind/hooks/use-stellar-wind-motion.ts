...
export interface StellarWindMotionState {
  time: number;
...
export function useStellarWindMotion(): StellarWindMotionState {
  const stateRef = useRef<StellarWindMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
