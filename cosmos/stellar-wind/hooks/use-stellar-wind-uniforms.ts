...
import { StellarWindMotionState } from './use-stellar-wind-motion';

export interface StellarWindUniforms {
  uTime: { value: number };
...
export function useStellarWindUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: StellarWindMotionState,
  breathPhase: number,
