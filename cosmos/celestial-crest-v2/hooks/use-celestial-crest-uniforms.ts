/**
 * Celestial Crest v2 Uniforms Hook
 * 
...
import { CelestialCrestMotionState } from './use-celestial-crest-motion';

export interface CelestialCrestUniforms {
  uTime: { value: number };
...
export function useCelestialCrestUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CelestialCrestMotionState,
  breathPhase: number,
