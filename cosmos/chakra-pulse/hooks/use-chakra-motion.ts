...
export interface ChakraPulseMotionState {
  time: number;
...
export function useChakraPulseMotion(): ChakraPulseMotionState {
  const stateRef = useRef<ChakraPulseMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
