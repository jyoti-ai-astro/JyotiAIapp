...
import { ChakraPulseMotionState } from './use-chakra-motion';

export interface ChakraPulseUniforms {
  uTime: { value: number };
...
export function useChakraPulseUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: ChakraPulseMotionState,
  breathPhase: number,
