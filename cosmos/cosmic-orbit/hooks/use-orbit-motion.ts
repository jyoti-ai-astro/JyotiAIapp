...
export interface CosmicOrbitMotionState {
  time: number;
...
export function useCosmicOrbitMotion(): CosmicOrbitMotionState {
  const stateRef = useRef<CosmicOrbitMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
