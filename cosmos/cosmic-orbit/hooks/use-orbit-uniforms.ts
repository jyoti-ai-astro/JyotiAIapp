...
import { CosmicOrbitMotionState } from './use-orbit-motion';

export interface CosmicOrbitUniforms {
  uTime: { value: number };
...
export function useCosmicOrbitUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: CosmicOrbitMotionState,
  breathPhase: number,
