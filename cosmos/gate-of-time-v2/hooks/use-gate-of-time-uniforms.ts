...
import { GateOfTimeMotionState } from './use-gate-of-time-motion';

export interface GateOfTimeUniforms {
  uTime: { value: number };
...
export function useGateOfTimeUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: GateOfTimeMotionState,
  breathPhase: number,
