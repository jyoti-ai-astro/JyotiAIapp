...
export interface AstralLotusMotionState {
  time: number;
...
export function useAstralLotusMotion(): AstralLotusMotionState {
  const stateRef = useRef<AstralLotusMotionState>({
    time: 0,
    scrollProgress: 0,
    bassMotion: 0,
    midMotion: 0,
