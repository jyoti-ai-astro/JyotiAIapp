...
import { AstralLotusMotionState } from './use-lotus-motion';

export interface AstralLotusUniforms {
  uTime: { value: number };
...
export function useAstralLotusUniforms(
  material: THREE.ShaderMaterial | null,
  motionState: AstralLotusMotionState,
  breathPhase: number,
