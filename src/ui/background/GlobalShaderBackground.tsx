...
void main(){gl_Position=position;}`;
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("WebGL2 not available. Global shader background disabled.", error);
      return;
    }
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none">
      <canvas
        ...
        style={{ 
          background: "#05050A",
          opacity: 0.3, // Optimized opacity to not overpower UI
        }}
        aria-hidden="true"
      />
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 50% 50%, rgba(10, 15, 31, 0.4) 0%, rgba(5, 5, 10, 0.8) 100%)',
