/**
 * Astro Page Error Boundary (Phase 29 - F44)
 */
...
export default function AstroError({
  error,
  reset,
}: {
    ...
    <div className="min-h-screen bg-gradient-to-b from-cosmic via-mystic to-cosmic flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-2xl font-display font-bold text-gold mb-4">
          Planetary alignments are recalibrating
        </h1>

        <p className="text-white/70 mb-6">
          The astrological engine is reconnecting to the cosmic database.
        </p>
