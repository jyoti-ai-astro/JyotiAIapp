...
- AI: `AI_PROVIDER`, `EMBEDDING_PROVIDER`, `OPENAI_API_KEY`, `GEMINI_API_KEY`, `GURU_MODEL_NAME`, `PREDICTION_MODEL_NAME` (AI routes/services).
...
- Email: `ZEPTO_API_URL`, `ZEPTO_API_TOKEN`, `ZEPTO_DOMAIN`, `SENDER_EMAIL`.
