...
export const FEATURE_READINESS_REGISTRY: FeatureReadinessRegistry = {
  ...
  business: {
    ...
    dependencies: [
      ...
      'app/api/business/compatibility/route.ts',
      'lib/engines/career/business-compatibility.ts',
    ],
    notes: 'User page/hook disables analysis, but the ticket-guarded API route and heuristic business compatibility engine are present.',
  },
  compatibility: {
    key: 'compatibility',
    ...
    dependencies: [
      ...
      'lib/engines/relationship/compatibility-engine.ts',
    ],
    notes: 'User page/hook disables partner entry, but the ticket-guarded API route and heuristic compatibility engine are present.',
  },
  numerology: {
    key: 'numerology',
    label: 'Numerology',
